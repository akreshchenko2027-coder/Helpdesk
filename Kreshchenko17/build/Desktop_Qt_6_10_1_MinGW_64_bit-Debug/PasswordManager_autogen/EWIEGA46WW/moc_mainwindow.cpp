...
<<<<<<< HEAD
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onItemChanged'
        QtMocHelpers::SlotData<void(QStandardItem *)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Slot 'onExit'
...
<<<<<<< HEAD
        ...
        case 2: _t->onItemChanged((*reinterpret_cast<std::add_pointer_t<QStandardItem*>>(_a[1]))); break;
