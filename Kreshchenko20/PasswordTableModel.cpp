...
int PasswordTableModel::rowCount(const QModelIndex &parent) const { Q_UNUSED(parent); return m_items.size(); }
int PasswordTableModel::columnCount(const QModelIndex &parent) const { Q_UNUSED(parent); return 6; }
...
QVariant PasswordTableModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    ...
    switch (section) {
    case 0: return "ID"; case 1: return "Title"; case 2: return "Login";
    case 3: return "Website"; case 4: return "Category"; case 5: return "Updated";
    default: return {};
    }
}
...
Qt::ItemFlags PasswordTableModel::flags(const QModelIndex &index) const
{
    ...
    if (index.column() > 0 && index.column() < 5) return Qt::ItemIsSelectable | Qt::ItemIsEnabled | Qt::ItemIsEditable;
...
const PasswordRecord& PasswordTableModel::itemAt(int row) const { return m_items[row]; }
